...
%% %%%%%%%%%%%
% TODO:
% loop f�r weiteres empfangen
%% %%%%%%%%%%%

%% M�gliche Fehler des Algorithmus
% Stop nach Start: da nur Prozesse starten die nur Nachbarn mit kleineren Zahlen haben -> Stillstand
% Zu fr�hes Ende:  da Probleme bei der Abstimmung entstehen k�nnen -> Abbruch zu fr�h -> falscher ggt

% Nameservicenode auf lab22
% Kommunikation �ber Name, Node
